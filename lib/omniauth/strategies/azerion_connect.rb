...
module OmniAuth
  module Strategies
    class AzerionConnect < OmniAuth::Strategies::OAuth2
      ...
      OmniAuth.config.add_camelization('azerion_connect', 'AzerionConnect')
      OmniAuth.config.add_camelization('azerionconnect', 'AzerionConnect')
    end
  end
end
